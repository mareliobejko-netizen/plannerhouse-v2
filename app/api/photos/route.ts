...
export async function GET(req: Request) {
  try {
    ...
    if (apartmentId === "apt_ch" && photos.length === 0) {
      return NextResponse.json({
        photos: [
          { publicId: "local/apt_ch/living-room", url: "/coach-house/living-room.jpg", sortOrder: 0, isCover: true },
          { publicId: "local/apt_ch/bedroom", url: "/coach-house/bedroom.jpg", sortOrder: 1, isCover: false },
          { publicId: "local/apt_ch/bedroom-2", url: "/coach-house/bedroom-2.jpg", sortOrder: 2, isCover: false },
          { publicId: "local/apt_ch/bathroom", url: "/coach-house/bathroom.jpg", sortOrder: 3, isCover: false },
        ],
      });
    }
